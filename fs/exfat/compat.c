...
/*
 * Minimal C library stubs used by the exFAT library when built
 * freestanding.  We provide just enough functionality to keep the
 * formatting code and helpers happy; none of this code is expected to be
